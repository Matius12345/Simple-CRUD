-- Ready-to-import SQL for Project1 (CRUD Simple)
-- Created: automatic export for phpMyAdmin import or mysql CLI
...
-- Optional: add status column (keeps compatibility with migrations)
-- Note: some MySQL versions will fail IF NOT EXISTS for ALTER; uncomment if needed
